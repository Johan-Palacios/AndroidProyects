    ...
    private void capturarFoto() {
        ...
        if (i.resolveActivity(getPackageManager()) != null) {
            ...
            if (imagenArchivo != null) {                                                    //aqui estaba el detalle una mayuscula
                ...
                actionPhoto dataPhoto = new actionPhoto(MainActivity.this);
                //Codigo de base de datos
                long correlativo = dataPhoto.insertPhoto(ubicacionFoto);
                if (correlativo>0){
                    Toast.makeText(MainActivity.this, "Foto Registrada", Toast.LENGTH_LONG).show();
                }
                //otro
