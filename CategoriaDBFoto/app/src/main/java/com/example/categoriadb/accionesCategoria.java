...
public class accionesCategoria extends UniversalConexion{
    ...
    public long insertarCategoria(String nombreCategoria, String Descripcion, String Ubicacion, String picturePath)
    {
        long id = 0;
        try {
    ...
    public ArrayList<metodosCategoria> visualizarCliente()
    {
        ...
        if(cursorCategoria.moveToFirst()){
            do {
                ...
                obtenerInfoCategoria.setPicturePath(cursorCategoria.getString(4));
