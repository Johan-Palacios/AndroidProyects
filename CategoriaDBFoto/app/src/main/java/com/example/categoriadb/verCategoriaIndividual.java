...
public class verCategoriaIndividual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UpdateCategory = findViewById(R.id.btnActualizarCategoria);
        ...
        imagenVista = findViewById(R.id.verImagenIndividual);
        ...
        if (categoriaIndividualActual!=null)
        {
            ...
            imagenVista.setImageURI(Uri.parse(categoriaIndividualActual.getPicturePath()));
