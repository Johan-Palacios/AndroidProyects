...
public class MainActivity extends AppCompatActivity {
    FloatingActionButton btnTomarFoto, btnTomarSegundaFoto;
    ImageView vImagen, v2Imagen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnTomarSegundaFoto = findViewById(R.id.btnTomarFoto2);
        v2Imagen = findViewById(R.id.visorImagen2);
        segundaPantalla = findViewById(R.id.btnIrSegundaPantalla);
        segundaPantalla.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(MainActivity.this, segundaCamara.class);
                startActivity(i);
            }
        });
        ...
        btnTomarSegundaFoto.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                abrirSegundaCamara();
            }
        ...
        barraOpciones.setTitle("Otras Fotos");
    }

    private void abrirSegundaCamara() {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == 321 && resultCode == RESULT_OK)
        {
            Bundle foto = data.getExtras();
            Bitmap imagenFinal = (Bitmap) foto.get("data");
            v2Imagen.setImageBitmap(imagenFinal);
        }
    }
