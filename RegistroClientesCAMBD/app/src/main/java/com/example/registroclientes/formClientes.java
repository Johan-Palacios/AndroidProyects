...
public class formClientes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewImage = findViewById(R.id.imageViewCamCap);
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                long ultimoCliente = datosCliente.insertarCliente(campoNombre.getText().toString(),campoPais.getText().toString(), campoEmpresa.getText().toString(),picturePath);
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        {
            viewImage.setImageURI(Uri.parse(picturePath));
        }
    }
    ...
    private void shootPhoto() {
        ...
        if (i.resolveActivity(getPackageManager()) != null) {
            ...
            if (imagenArchivo != null) {                                                    //aqui estaba el detalle una mayuscula
                Uri fotoUri = FileProvider.getUriForFile(formClientes.this, "com.example.registroclientes", imagenArchivo);
